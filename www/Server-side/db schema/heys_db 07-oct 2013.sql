...
--
-- Host: localhost
-- Generation Time: Oct 07, 2013 at 05:47 AM
...
(2, 'ארומה', 77.5, 61, 0, 100, 6, 3, 1, 2, 'האומן 17 ירושלים', 35.208156, 31.751343, 0, '2013-01-31 00:00:00', '2013-10-01 14:30:00', 30, 'resources/images/logo.png', 19, 23, 8, NULL, 0, '', '', '', 0, 0, '1-800-202202', NULL, NULL),
...
(5, 'מייק פלייס', 72, 10, 100, 0, 0, 0, 1, 3, 'הירקון 22', 35.208156, 31.751343, 0, '2013-09-08 00:00:00', '2013-10-01 21:40:49', 60, 'resources/images/logo.png', 20, 25, 16, 'http://www.mikesplacebars.com/he/', NULL, 'גאז לאורך הלילה', 'הבר מאובזר ומגוון ועומד בסטנדרטים בינלאומיים. תמצאו בו מבחר רחב של בירות, מהחבית ובבקבוקים, המוגשות תמיד בטמפרטורה הנכונה, תפריט קוקטיילים עשיר ומגוון משקאות חריפים מכל הסוגים. כך שתמיד ולכולם יהיה מה לשתות. השילוב של טרנדים בינלאומיים בתחום האלכוהול, happy hour כל יום עד שעה מאוחרת, הלקוחות הקבועים יחד עם צוות העובדים החברותי יגרום לך לרצות ולקחת חלק בזה . . . תגיעו - תבינו!', '10:00-02:00', 2, 0, '02-654321', 'info@mikeplace.com', '1+1 על בירה');
...
(2, 30, '2013-10-04 12:57:39', 9, NULL, 1),
(3, 7, '2013-05-28 12:04:18', 12, NULL, 0),
(3, 23, NULL, 0, '0000-00-00 00:00:00', 0),
(3, 30, '2013-09-27 08:36:59', 3, NULL, 0),
(5, 30, '2013-10-04 15:08:13', 23, '2013-10-07 08:29:22', 0);
